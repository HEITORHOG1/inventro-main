* **Cardápio:** `http://localhost:8080/cardapio` — loja aberta 24/7, sem dropdown de zona, taxa detectada pelo CEP
* **Portal Motoboy:** `http://localhost:8080/motoboy` — telefone `11999999999`, senha `motoboy123`
* **Admin:** `http://localhost:8080/login` — `admin@admin.com` / `12345678`
...
| **Portal do Motoboy**    | http://localhost:8080/motoboy                | Portal mobile do entregador     |
...
| Usuario            | Telefone        | Senha          | Taxa/Entrega |
| ------------------ | --------------- | -------------- | ------------ |
| Joao Motoboy Teste | `11999999999` | `motoboy123` | R$ 6,00      |

**URL do Portal:** `http://localhost:8080/motoboy`

O motoboy acessa o portal pelo celular, faz login com telefone + senha, ve as entregas disponiveis e aceita pedidos. Apenas 1 entrega ativa por vez. O admin cria a conta do motoboy em Delivery > Entregadores (com senha e taxa fixa).
