...
<head>
    ...
    <title>Esqueci minha senha - <?php echo html_escape(isset($loja->nome) ? $loja->nome : 'Cardapio Digital'); ?></title>
...
<body>
    <div class="auth-container">
        <div class="auth-card">
            ...
            <p class="auth-subtitle">Informe seu e-mail para receber o link de redefinicao</p>
            ...
            <form method="POST" action="<?php echo base_url('cliente/esqueci-senha'); ?>">
            ...
            <div class="auth-links">
                <a href="<?php echo base_url('cliente/login'); ?>" class="back-login">
