<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary card-outline">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <?php echo form_open_multipart('menu/crole/role_update', 'class="form-inner"') ?>

            <div class="card-body">

                <div class="form-group row">
                    <label for="menu_title" class="col-sm-3 col-form-label text-right"><?php echo makeString(['role_name']); ?></label>
                    <div class="col-sm-6">
                        <input type="text" name="role_name" class="form-control" id="role_name" value="<?php echo html_escape($roleInfo->role_name); ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <textarea class="form-control" name="role_description" id="role_description"><?php echo html_escape($roleInfo->role_description); ?></textarea>
                    </div>
                </div>
            </div>
            <!-- /.card-body -->
                ...
                <div class="card-body">
                    ...
                    foreach ($modules as $module) {
                        $menu_item = $this->db->select('*')->from('sec_menu_item')->where('module', $module->module)->where('status', 1)
                                        ->get()->result();
                        ?>
                        <input type="hidden" name="module[]" value="<?php echo html_escape($module->module); ?>">
                        <table id="" class="table table-bordered table-striped">
                            <h4><?php echo ucwords(str_replace("_", " ", html_escape($module->module))); ?></h4>
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo makeString(['can_create']); ?>
                                        <label for="<?php echo $module->module; ?>_can_create_all" class="float-right">
                                            ...
                                            <input type="checkbox" id="<?php echo $module->module; ?>_can_create_all" class="can_create_all" value="<?php echo html_escape($module->module); ?>">
                                        </label>
                                    </th>
                                    <th><?php echo makeString(['can_read']); ?>
                                        <label for="<?php echo $module->module; ?>_can_read_all" class="float-right">
                                            ...
                                            <input type="checkbox" id="<?php echo $module->module; ?>_can_read_all" class="can_read_all" value="<?php echo html_escape($module->module); ?>">
                                        </label>
                                    </th>
                                    <th><?php echo makeString(['can_edit']); ?>
                                        <label for="<?php echo $module->module; ?>_can_edit_all" class="float-right">
                                            ...
                                            <input type="checkbox" id="<?php echo $module->module; ?>_can_edit_all" class="can_edit_all" value="<?php echo html_escape($module->module); ?>">
                                        </label>
                                    </th>
                                    <th><?php echo makeString(['can_delete']); ?>
                                        <label for="<?php echo $module->module; ?>_can_delete_all" class="float-right">
                                            ...
                                            <input type="checkbox"  id="<?php echo $module->module; ?>_can_delete_all" class="can_delete_all" value="<?php echo html_escape($module->module); ?>">
                                        </label></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                if (!empty($menu_item)) {
                                    ...
                                    foreach ($menu_item as $menu) {
                                        $ck_data = $this->db->select('*')
                                                        ...
                                                        ->where('role_id', $roleInfo->role_id)->get('sec_role_permission')->row();
                                        ?>
            ...
            <div class="card-footer">
                <input type="hidden" name="role_id" value="<?php echo html_escape($roleInfo->role_id) ?>">
