<div class="card card-primary card-outline">
    ...
    <div class="card-header">
        ...
        <?php if ($this->permission->method('bank', 'create')->access()): ?>
            <h4><?php echo html_escape('Update Bank'); ?> <small class="float-right"><a href="<?php echo base_url('bank/bank/bank_list') ?>" class="btn btn-primary btn-md" ><i class="ti-plus" aria-hidden="true"></i>
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="text" name="bank_name" class="form-control" value="<?php echo html_escape((!empty($banks->bank_name) ? $banks->bank_name : '')) ?>" id="bank_name" placeholder="Bank Name">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="account_no" class="form-control" value="<?php echo html_escape((!empty($banks->account_no) ? $banks->account_no : '')) ?>" id="account_no" placeholder="Account No">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="branch_name" class="form-control" value="<?php echo html_escape((!empty($banks->branch_name) ? $banks->branch_name : '')) ?>" id="branch_name" placeholder="Branch Name">
                    </div>
                </div>
