<script type="text/javascript">
 ...
 'use strict';
	...
	{
	    $("#dip").attr("action", "<?php echo base_url('hrm/attendance/save_attendance')?>");
	...
	function deleteAttendance(attendance_id)
	{
		...
		if(confirm('Do you want to delete')===false){
			...
			var submit_url = "<?php echo base_url('hrm/attendance/delete_attendance'); ?>";
  ...
  "use strict";
	function addOutTime(attendance_id)
	{
		...
		if(confirm('Do you want to live')===false){
			...
			var submit_url = "<?php echo base_url('hrm/attendance/add_out_time'); ?>";
			var dataString = "attendance_id="+attendance_id;
	...
	function editAttendance(attendance_id)
	{
		...
		if(confirm('Do you want to update this')===false){
			...
			var submit_url = "<?php echo base_url('hrm/attendance/edit_attendance'); ?>";
			var dataString = "attendance_id="+attendance_id;
			...
			$.ajax({
				...
				success: function(res) {
				    ...
				    $("#edit_at").attr("action", "<?php echo base_url('hrm/attendance/update_attendance')?>");
