                            ...
                            foreach ($return_list as $return) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="<?php echo base_url('return/returns/delete/' . $return->return_id); ?>" data-toggle='tooltip' data-placement='top' data-original-title='Delete' class="btn btn-danger btn-sm" onclick="event.preventDefault(); var u=this.href; showConfirm('Deseja excluir este registro?', function(){ window.location.href=u; })"><i class="fas fa-trash"></i></a> 
                                    </td>
                                </tr>
                                <?php
                            }
