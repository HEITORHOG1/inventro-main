...
<div class="row">
    <div class="col-sm-12">
        <div class="mb-2">
            <a href="<?php echo base_url('return/returns/supplier_return_list') ?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-align-justify"> </i>
                <?php echo makeString(['supplier_return_list']); ?>
            </a>
        </div>
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title"><?php echo makeString(['supplier_return_details']); ?></h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6 text-right">
                        <h4 class="m-t-0"><?php echo makeString(['return']); ?> : <?php echo html_escape($return_info->purchase_id ?? ''); ?></h4>
