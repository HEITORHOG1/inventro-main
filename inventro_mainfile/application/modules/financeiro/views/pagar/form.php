<div class="card card-primary card-outline">
    ...
    <?php echo form_open('financeiro/contas_pagar/salvar', array('class' => 'form-horizontal', 'id' => 'formContaPagar')) ?>
    ...
    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="descricao" name="descricao" 
                           ...
                           placeholder="Ex: Compra de mercadorias, Aluguel, Energia..." required>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select class="form-control" id="tipo" name="tipo">
                        <option value="despesa" <?php echo (isset($conta->tipo) && $conta->tipo == 'despesa') ? 'selected' : ''; ?>>
                            <?php echo makeString(['tipo_despesa']); ?>
                        </option>
                        <option value="compra" <?php echo (isset($conta->tipo) && $conta->tipo == 'compra') ? 'selected' : ''; ?>>
                            <?php echo makeString(['tipo_compra']); ?>
                        </option>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    <label for="fornecedor_id"><?php echo makeString(['supplier']); ?></label>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <small class="text-muted">Não é possível alterar parcelas após criação</small>
                    <?php endif; ?>
                </div>
            </div>
        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="valor_parcela" readonly 
                               value="<?php echo isset($conta->valor_original) ? number_format($conta->valor_original, 2, ',', '.') : '0,00'; ?>">
                    </div>
                </div>
            </div>
        </div>
