...
<div class="card card-success card-outline">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fas fa-dollar-sign"></i> <?php echo makeString(['baixa_recebimento']); ?>
        </h3>
    ...
    <div class="card-body">
                ...
                <div class="callout callout-info">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <?php echo $conta->cliente_nome ?: 'Não informado'; ?>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-2 text-right">
                            <strong><?php echo makeString(['valor_recebido']); ?>:</strong><br>
                            <span class="text-success">R$ <?php echo number_format($conta->valor_recebido, 2, ',', '.'); ?></span>
                        </div>
                        <div class="col-md-2 text-right">
        ...
        <!-- Formulário de Baixa -->
        <?php echo form_open('financeiro/contas_receber/registrar_baixa', array('class' => 'form-horizontal', 'id' => 'formBaixa')) ?>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="observacao" name="observacao" rows="2" 
                              placeholder="Observação do recebimento..."></textarea>
                </div>
            </div>
        </div>
